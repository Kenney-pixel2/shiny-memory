...
class BoundText(tk.Text):
    ...
    def _set_content(self, *_):
        ...
        self.insert('1.0', self._varible.get())
...
class DataRecordForm(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        LabelInput(
                p_info, "Plants",
                input_class=ttk.Spinbox, var=self._vars['Plants'],
        ...
        LabelInput(
                ...
                input_args=(sticky=(tk.W+tk.E), row=3, column=0)
        )
...
class Application(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def _on_save(self):
            ...
            # For now, we save to a harcoded filename with a datestring
